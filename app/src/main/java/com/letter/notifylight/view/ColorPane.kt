...
constructor(context: Context, attrs: AttributeSet?=null, defStyleAttr: Int, defStyleRes: Int):
    ...
    init {
        ...
        color = attrArray.getColor(R.styleable.ColorPane_android_color, 0)
        strokeColor = attrArray.getColor(R.styleable.ColorPane_android_strokeColor, 0)
        strokeWidth = attrArray.getDimension(R.styleable.ColorPane_android_strokeWidth, 0f)
        checked = attrArray.getBoolean(R.styleable.ColorPane_android_checked, false)
